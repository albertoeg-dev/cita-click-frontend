    ...
    <div class="fixed top-4 right-4 z-50 space-y-2 w-96">
      <TransitionGroup name="toast">
        <div
          ...
          :key="toast.id"
          :class="['rounded-lg shadow-lg p-4 flex items-start gap-3', toastClasses[toast.type]]"
        >
          <!-- Icon -->
...
const error = (message, description = '', duration = 5000) => {
  return addToast(message, 'error', description, duration)
}

const warning = (message, description = '', duration = 4000) => {
