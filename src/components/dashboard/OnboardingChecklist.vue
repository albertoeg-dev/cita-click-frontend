<template>
  <div class="card bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 border-l-4 border-blue-600 p-4">
    <div class="flex items-start justify-between mb-3">
      <div>
        ...
        <p class="text-xs text-slate-600">{{ tareasCompletadas }}/{{ tareasTotales }} pasos completados</p>
      </div>
      <button
    ...
    <div class="mb-3">
      <div class="w-full bg-slate-200 rounded-full h-1.5">
        <div
          class="bg-gradient-to-r from-blue-600 to-purple-600 h-1.5 rounded-full transition-all duration-500"
    ...
    <div class="space-y-1.5">
      ...
      >
        <div class="flex-shrink-0">
          ...
          >
            <svg v-if="tareas.negocioConfigurado" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      >
        <div class="flex-shrink-0">
          ...
          >
            <svg v-if="tareas.serviciosAgregados" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
            </svg>
          </div>
        </div>
      ...
      >
        <div class="flex-shrink-0">
          ...
          >
            <svg v-if="tareas.clientesRegistrados" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
            </svg>
          </div>
        </div>
      ...
      >
        <div class="flex-shrink-0">
          ...
          >
            <svg v-if="tareas.primeracitaCreada" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
            </svg>
          </div>
        </div>
    ...
    <div v-if="todasCompletadas" class="mt-3 p-2.5 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg">
      <div class="flex items-center gap-2">
        <div class="text-xl">🎉</div>
        <div class="flex-1">
          <p class="text-sm font-bold text-green-900">¡Felicidades!</p>
          <p class="text-xs text-green-800">Has completado la configuración inicial.</p>
        </div>
      </div>
    </div>
  </div>
